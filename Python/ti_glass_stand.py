...
def read_currents(delay, evm, rw_reg, resp_reg):
	...
	while success==0:
		try:
			...
			debug_output.write(led_currents + "\n")
			success = 1
		except IOError:
			if loop_count<150:
				print("starting over")
...
def auto_shutdown(pause=delay, evm_sensor=evm_sense, gpio_channel=channel3):
	k.press_key(control_key)
	k.tap_key('w', 2)
...
try:
	while 1:
		print("normal loop")
		#debug_output.write("normal loop\n")
		time.sleep(1)
