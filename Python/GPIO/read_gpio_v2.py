...
gpio.add_event_detect(channel_1, gpio.RISING, callback = read_gpio)
gpio.add_event_detect(channel_2, gpio.RISING, callback = read_gpio)
gpio.add_event_detect(channel_3, gpio.RISING, callback = read_gpio)
gpio.add_event_detect(channel_4, gpio.RISING, callback = read_gpio)
gpio.add_event_detect(channel_5, gpio.RISING, callback = read_gpio)
